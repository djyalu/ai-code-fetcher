        ...
        <div className="flex flex-col h-full bg-card">
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-border">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-lg font-semibold text-foreground">AI Model Management</h2>
                        <p className="text-xs text-muted-foreground">Add, edit, or remove AI models dynamically</p>
                    </div>
                </div>
                <div>
                    <Button
